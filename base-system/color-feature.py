...
def ColorFeatures(m, image):
    c_bb, c_bg, c_br, c_gg, c_br, c_gr, c_rr = covariance(m, image)
    adhocb1, adhocg1, adhocr1 = adhoc(m, image, avgradius, 1/3, c)
    adhocb2, adhocg2, adhocr2 = adhoc(m, image, avgradius, 9/10, c)
